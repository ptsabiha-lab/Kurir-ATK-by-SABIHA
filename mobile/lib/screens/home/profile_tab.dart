...
class ProfileTab extends StatelessWidget {
  ...
  void _showAbout(BuildContext context) {
    showAboutDialog(
      ...
      applicationVersion: 'Versi ${AppInfo.version} (build ${AppInfo.buildNumber})',
      applicationIcon: const BrandMark(size: 48),
      children: const [Text('Belanja alat tulis & kebutuhan kantor, diantar kurir sampai tujuan.')],
    );
  }
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Kurir ATK by SABIHA • Versi ${AppInfo.version} (build ${AppInfo.buildNumber})\n'
...
class _MenuCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Column(
        children: [
          for (var i = 0; i < children.length; i++) ...[if (i > 0) const Divider(indent: 64), children[i]],
        ],
      ),
    );
  }
